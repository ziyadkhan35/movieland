...
export const getServerSideProps = async (context) => {
  const req = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=492ffd09fc56b252b897b973c6f119c6&${context.params.slug[0]}&sort_by=popularity.desc&${context.params.slug[1]}&${context.params.slug[2]}&${context.params.slug[3]}&${context.params.slug[4]}`)
